...
%4$s' );
			wp_mail( $new_user_email, sprintf( __( '[%s] Joining confirmation' ), wp_specialchars_decode( get_option( 'blogname' ) ) ), sprintf( $message, get_option( 'blogname' ), site_url(), wp_specialchars_decode( translate_user_role( $role['name'] ) ), site_url( "/newbloguser/$newuser_key/" ) ) );
