...
<body class="wp-core-ui">
	<h1 id="logo"><a href="http://rapido.press/">RapidoPress</a></h1>
	<h2>Error: PHP is not running</h2>
	<p>RapidoPress requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned off.</p>
</body>
</html>
<?php
}
...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title><?php _e( 'RapidoPress &rsaquo; Installation' ); ?></title>
	<?php
...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	...
	<p class="step"><input type="submit" name="Submit" value="<?php esc_attr_e( 'Install RapidoPress' ); ?>" class="button button-large" /></p>
...
<p><?php _e( 'Welcome to the famous five-minute RapidoPress installation process! Just fill in the information below and you&#8217;ll be on your way to using the most extendable and powerful personal publishing platform in the world.' ); ?></p>
...
<p><?php _e( 'RapidoPress has been installed. Were you expecting more steps? Sorry to disappoint.' ); ?></p>
