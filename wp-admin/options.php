...
$whitelist_options = array(
	'general' => array( 'blogname', 'blogdescription'),
	'localization' => array(  'WPLANG', 'gmt_offset', 'date_format', 'time_format', 'start_of_week', 'timezone_string' ),
	'contents' => array( 'show_on_front', 'page_on_front', 'page_for_posts', 'posts_per_page', 'default_category',  'default_post_format', 'limit_revisions' ),
	'users' => array( 'show_avatars', 'avatar_default' ),
...
if ( ! in_array( get_option( 'blog_charset' ), array( 'utf8', 'utf-8', 'UTF8', 'UTF-8' ) ) )
	$whitelist_options['localization'][] = 'blog_charset';
...
/** Users */
$whitelist_options['users'][] = 'users_can_register';
$whitelist_options['users'][] = 'default_role';
...
if ( 'update' == $action ) {
	...
	if ( 'localization' == $option_page ) {
		...
		if ( ! empty( $_POST['WPLANG'] ) && ( is_super_admin() ) ) { // @todo: Skip if already installed
