...
class WP_Query {
	...
	public function parse_query( $query =  '' ) {
		...
		if ( !( $this->is_singular || $this->is_archive || $this->is_search || $this->is_404 || $this->is_admin || $this->is_comments_popup || $this->is_robots ) )
			$this->is_home = true;
	...
	public function setup_postdata( $post ) {
		...
		/*
		 * Force full post content when viewing the permalink for the $post, Otherwise respect the 'more' tag.
		 */
