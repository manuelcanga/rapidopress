...
foreach ( array( 'content_save_pre', 'excerpt_save_pre', 'comment_save_pre', 'pre_comment_content' ) as $filter ) {
	add_filter( $filter, 'force_balance_tags', 50 );
}
...
foreach ( array( 'single_post_title', 'single_cat_title', 'single_tag_title', 'single_month_title', 'nav_menu_attr_title', 'nav_menu_description' ) as $filter ) {
	add_filter( $filter, 'wptexturize' );
	add_filter( $filter,  function($text) { return strip_tags($text); }  );
}
...
add_action( 'wp_head',             'rapidopress_tracking_code'              );
...
// Feed Generator Tags
foreach ( array( 'opml_head', 'app_head' ) as $action ) {
...
add_action( 'plugins_loaded',              RAPIDO_INCLUDES.'widgets/load/wp_maybe_load_widgets.php',  0    );
