...
/**
 * Put tracking code in wp_head
 * @since rapidopress 0.4
 */
function rapidopress_tracking_code() {
 ...
 * @since 4.4.2 / 0.3
 *
 * @param string $html to minize.
 * @return string miminized $html
 */
function wp_htmlmin( $html ) {
	    $search = array(
				'/[\n\r]/', //line break
	        '/\s{2,}/s',  // shorten multiple whitespace sequences

			'/<!--\s.*?-->/' //Eliminamos comentarios no condicionales
	        );
	    $minimize = array(
				' ', //line break
	        ' ',  // shorten multiple whitespace sequences

			'' //Eliminamos comentarios no condicionales
	        );
	    return preg_replace($search, $minimize, $html);
}
