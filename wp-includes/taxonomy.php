 ...
 *
 * @since 3.0.0
 * @global array $wp_taxonomies The registered taxonomies.  Modifies taxonomy object
 *
 * @param string $taxonomy Name of taxonomy object
 ...
 *
 * '{@see 'get_$taxonomy'} - Takes two parameters the term Object and the taxonomy name.
...
function _wp_check_split_default_terms( $term_id, $new_term_id, $term_taxonomy_id, $taxonomy ) {
	...
	if ( $term_id == get_option( 'default_category', -1 ) ) {
		update_option( 'default_category', $new_term_id );
	}
}
