...
function wp_plugin_directory_constants() {
	if ( !defined('WP_CONTENT_URL') )
		define( 'WP_CONTENT_URL', root_url('/wp-content') ); // relative url from domain - WP_CONTENT_DIR is defined further up
...
function wp_functionality_constants() {
	...
	if ( !defined('WP_POST_REVISIONS') )
		define('WP_POST_REVISIONS', get_option('limit_revisions') );
